      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="row">              
            <div class="col-lg-12">
              <form class="card" method="POST" action="src/controllers/ProdutoController.php">
                <div class="card-body">
                  <?php
                    if ($_SESSION['success']) {
                      echo 
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input required type="number" name="estoque" class="form-control" placeholder="10..">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Código de barras</label>
                        <input required type="number" name="codigo" class="form-control" placeholder="78978978978978">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
