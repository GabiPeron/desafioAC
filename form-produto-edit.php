...
$produto = Produto::find($_GET['produto'])[0];
?>
      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="row">              
            <div class="col-lg-12">
              <form class="card" method="POST" action="src/controllers/ProdutoController.php?produto=<?php echo $produto['id']; ?>">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="descricao" placeholder="Arroz.." value="<?php echo $produto['descricao']; ?>">
		                  </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Estoque</label>
                        <input name="estoque" type="number" class="form-control" placeholder="10.." value="<?php echo $produto['estoque']; ?>">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Código de barras</label>
                        <input value="<?php echo $produto['codigo']; ?>" name="codigo" type="number" class="form-control" placeholder="78978978978978">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
